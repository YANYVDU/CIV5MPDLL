...
// -- ints --
	...
	m_iDIPLOMATIC_OVEREXTENSION_DECAY_MODIFIER(10),
	m_iDIPLOMATIC_OVEREXTENSION_RISE_MODIFIER(-10),
	m_iDIPLOMATIC_OVEREXTENSION_UNHAPPINESS_MODIFIER(3),
	...
	m_iCS_CULTURED_POLICY_COST_MODIFIER(-2),
	m_iCS_CULTURED_IMMIGRATION_REGRESSAND_MODIFIER(-2),
	m_iCS_MILITARISTIC_LAND_XP_PER_TURN(1),
	m_iCS_MARITIME_SEA_TRADE_GOLD_PER_ERA(1),
	m_iCS_RELIGIOUS_FAITH_COST_MODIFIER(-5),
	m_iCS_RELIGIOUS_PRESSURE_MODIFIER(10),
	m_iCS_MERCANTILE_LUXURY_HAPPINESS_MODIFIER(5),
	m_iCS_MERCANTILE_TREASURY_INTEREST_RATE(1),
	m_iCS_TREASURY_INTEREST_CAP_MULTIPLIER(100),
#endif
...
void CvGlobals::cacheGlobals()
{
	...
	m_iDIPLOMATIC_OVEREXTENSION_DECAY_MODIFIER = getDefineINT("DIPLOMATIC_OVEREXTENSION_DECAY_MODIFIER");
	m_iDIPLOMATIC_OVEREXTENSION_RISE_MODIFIER = getDefineINT("DIPLOMATIC_OVEREXTENSION_RISE_MODIFIER");
	m_iDIPLOMATIC_OVEREXTENSION_UNHAPPINESS_MODIFIER = getDefineINT("DIPLOMATIC_OVEREXTENSION_UNHAPPINESS_MODIFIER");
...
#endif
#if defined(MOD_SP_CITYSTATE_BASIC)
	m_iCS_CULTURED_POLICY_COST_MODIFIER = getDefineINT("CS_CULTURED_POLICY_COST_MODIFIER");
	m_iCS_CULTURED_IMMIGRATION_REGRESSAND_MODIFIER = getDefineINT("CS_CULTURED_IMMIGRATION_REGRESSAND_MODIFIER");
	m_iCS_MILITARISTIC_LAND_XP_PER_TURN = getDefineINT("CS_MILITARISTIC_LAND_XP_PER_TURN");
	m_iCS_MARITIME_SEA_TRADE_GOLD_PER_ERA = getDefineINT("CS_MARITIME_SEA_TRADE_GOLD_PER_ERA");
	m_iCS_RELIGIOUS_FAITH_COST_MODIFIER = getDefineINT("CS_RELIGIOUS_FAITH_COST_MODIFIER");
	m_iCS_RELIGIOUS_PRESSURE_MODIFIER = getDefineINT("CS_RELIGIOUS_PRESSURE_MODIFIER");
	m_iCS_MERCANTILE_LUXURY_HAPPINESS_MODIFIER = getDefineINT("CS_MERCANTILE_LUXURY_HAPPINESS_MODIFIER");
	m_iCS_MERCANTILE_TREASURY_INTEREST_RATE = getDefineINT("CS_MERCANTILE_TREASURY_INTEREST_RATE");
	m_iCS_TREASURY_INTEREST_CAP_MULTIPLIER = getDefineINT("CS_TREASURY_INTEREST_CAP_MULTIPLIER");
#endif
	...
	m_iMINOR_GOLD_GIFT_HUGE = getDefineINT("MINOR_GOLD_GIFT_HUGE");
